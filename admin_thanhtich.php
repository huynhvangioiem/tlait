...
<?php 
	...
	if(isset($_POST['btnThem'])){
		...
		$Result = mysqli_query($Conn,"Insert Into thanhtich (Tt_Ten, Tt_GiaTri, Tt_Link, Tt_Ngay) values ('$Ten', '$GiaTri','$Link','$date')") or die(mysqli_connect_error($Conn));
	...
	if(isset($_GET["id"])){
		$id = $_GET["id"];	
		mysqli_query($Conn,"delete from thanhtich where Tt_id = $id");
		echo '<meta http-equiv="refresh" content="0;admin_thanhtich.php" />';
	}
?>
<body>
<div class="container">
    ...
    <div class="col-lg-12 title">
      <form name="formLogOut" action="" enctype="multipart/form-data" method="post" id="formLogOut">
      	Cập Nhật Thông Tin Thành Tích Hoặc 
    ...
    <div class="col-lg-12">
    	<form action="" method="post" enctype="multipart/form-data" name="formHoatDong" id="formHoatDong">
      	<div class="row"><input class="form-control" name="txtTen" type="text" required placeholder="Tên Hoạt Động" id="txtTen"></div>
    ...
    <div class="col-lg-12">
    	<div class="row title">Danh Sách Thành Tích Đã Thêm</div>
      <div class="row">
          ...
          <tr>
            ...
            <td><?php echo $Row['Tt_GiaTri']; ?></td>
            <td><?php echo $Row['Tt_Link']; ?></td>
            <td align="center"><?php echo $Row['Tt_Ngay']; ?></td>
            <td align="center"><a href="admin_thanhtich.php?id=<?php echo $Row['Tt_id'];?>"><img src="img/icon/x-button.png"/></a></td>
          </tr>
          <?php $stt++;}?>
        </table>
